        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    "This is my network scanner project. Please input a domain name and ending (like youtube.com) and then select the information you want to learn about. Be patient its not lightning fast but it gets the job done"
                )
            );
        }
    }]);
